...
[ios SDK Release on GitHub](https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk-prod-playground/releases)
...
`pod 'StagingWalleeSdk', '1.2.0.667', :source=> 'https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk-prod-playground.git'`
